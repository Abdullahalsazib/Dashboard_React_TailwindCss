  ...
  return (
    ...
    <div className=" grid gap-y-4 lg:gap-y-6">
      ...
      <div className=" w-full xl:space-y-0 space-y-5 xl:flex gap-x-0 xl:gap-x-3 2xl:gap-x-10">
        <div className=" shadow-lg dark:shadow-lg dark:shadow-slate-600 px-2 md:px-7 xl:w-[70%] rounded-lg dark:bg-gradient-to-r dark:from-sky-400 from-green-300 dark:to-green-400 to-blue-500  bg-gradient-to-r text-black flex items-center justify-between ">
          <div className=" py-5 space-y-2 md:space-y-4">
            <div className=" 2xl:w-[500px]">
              <h1 className=" md:text-[28px] 2xl:text-[40px]  dark:text-slate-200 capitalize font-bold">
                welcome back ✅ <br /> Fabiana Copmany
              </h1>
              <p className=" text-[9px] md:text-sm font-semibold dark:text-slate-300 dark:capitalize text-slate-600">
